...
const Page = () => {
    ...
    return (
        <div className="min-h-screen w-full flex justify-center items-start bg-gray-50 p-4 sm:p-6">
            {feedback ? (
                <div className="bg-white shadow-lg rounded-xl w-full max-w-3xl p-6 space-y-6 text-black dark:text-black">
                    <h1 className="text-2xl font-bold text-center text-blue-600">
                        {feedback.interviewId?.role?.toUpperCase() || "Loading..."} DEVELOPER INTERVIEW
                    </h1>

                    <div className="flex flex-col sm:flex-row justify-between sm:items-center text-gray-700 dark:text-black">
                ...
                <p className="text-xl text-gray-600 dark:text-black">Loading...</p>
            )}
        </div>
    )
}
